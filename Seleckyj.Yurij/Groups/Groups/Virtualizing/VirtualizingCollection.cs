...
namespace Groups.Virtualizing
{
    ...
    public class VirtualizingCollection<T> : IList<T>, IList
    {
        ...
        /// <param name="itemsProvider">The items provider.</param>
        /// <param name="pageSize">Size of the page.</param>
        public VirtualizingCollection(List<Employee> list,IItemsProvider<T> itemsProvider, int pageSize)
        {
            this.list = list;
            _itemsProvider = itemsProvider;
            _pageSize = pageSize;
        ...
        {
            return ItemsProvider.FetchRange(list,pageIndex * PageSize, PageSize);
        }
